...
void predict(FILE *input, const std::string& outputName);
static char* readline(FILE *input);

void useSVM(const std::string& inputTrainFile, const std::string& inputTestFile, const float paramC, const float paramGamma)
{
    ...
    // Input Args
    param.C = paramC;                				// First value is C value for training model
    param.gamma = paramGamma;            			// Second value is gamma value for training model
    strcpy(input_file_name, inputTrainFile.c_str());       // Third value is input training file name for generating model
    input_training = fopen(inputTestFile.c_str(), "r");   		// Fourth value is testing data file name
	...
	predict(input_training, inputTestFile);
...
void predict(FILE *input, const std::string& outputName)
{
	std::string outTemp = outputName;
	outTemp.append(".predict");
